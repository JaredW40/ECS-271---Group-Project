...
For this project we plan to implement a number of machine learning techniques. Some that we have planned are decision trees, k-Nearest Neighbors, PCA and Perceptrons. Additionally, we would like to create a small feedforward neural network trained on the landmark coordinate data. 
